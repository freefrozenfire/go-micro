...
func New(service service.Service) (*Reporter, error) {
	...
	newReporter.counters = newReporter.newMetricFamily()
	newReporter.gauges = newReporter.newMetricFamily()
	newReporter.timings = newReporter.newMetricFamily()
...
// serialiseTags turns Tags into prometheus labels:
func (r *Reporter) serialiseTags(tags metrics.Tags) prometheus.Labels {
